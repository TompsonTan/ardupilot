# AP-H743l1 Flight Controller

The AP-H743l1 is a flight controller designed and produced by X-MAV
...
![X-MAV AP-H743l1 Front View](AP-H743l1_TopPort.png)

![X-MAV AP-H743l1  Back View](AP-H743l1_BottomPort.png)
...
The AP-H743l1 supports up to 8 PWM outputs.
...
The AP-H743l1 has a built-in compass sensor (QMC5883P), and you can also attach an external compass using I2C on the SDA and SCL connector.
